              ...
              <div className="flex flex-col space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <Button
                    ...
                    className="w-full py-5 px-8 text-lg font-bold bg-primary text-white rounded-2xl shadow-lg hover:bg-primary/90 hover:shadow-xl transform hover:scale-[1.02] transition-all duration-300"
                    size="lg"
