              ...
              <div className="flex flex-col space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <Button
                    ...
                    className="w-full py-5 px-8 text-lg font-bold bg-primary text-white hover:bg-primary/90 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300"
                    size="lg"
